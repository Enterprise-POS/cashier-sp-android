...
fun LoginRegisterScreen(navController: NavController, viewModel: LoginRegisterViewModel = hiltViewModel()) {
    ...
    val currentSegmented = remember { mutableStateOf("Login") }
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                if (currentSegmented.value == "Login") "Welcome back" else "Hello !",
                fontSize = 28.sp,
                color = Secondary,
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Text(
                if (currentSegmented.value == "Login") "Sign in to start a new sale or manage your store"
            ...
            Card(
                ...
                Column(
                    ...
                    if (currentSegmented.value == "Login") {
